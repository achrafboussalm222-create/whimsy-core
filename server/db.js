...
// Seeded the first time the server runs — after that, this file is never
// read again. All edits from the admin panel go straight into
// server/data/products.json, which acts as the site's database.
const SEED_PRODUCTS = [
  {
    id: "1",
...
export function uniqueSlug(base, products, excludeId) {
  let slug = base;
  let n = 2;
