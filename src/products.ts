// ---------------------------------------------------------------------------
// All products live here. To add, remove, or edit a product, just edit this
// array — every page (collection grid, filters, search, product pages,
// related products) reads from this single file.
//
// `images` accepts any image URL. These are placeholders (picsum.photos,
// seeded so they stay stable) — replace each with your own photo URLs or
// local imports (e.g. `import img from "../assets/tulip-1.jpg"`) whenever
// you're ready.
// ---------------------------------------------------------------------------
...
const img = (seed: string, n: number) => `https://picsum.photos/seed/whimsycore-${seed}-${n}/900/1100`;
